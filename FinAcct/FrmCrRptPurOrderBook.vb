...
Public Class FrmCrRptPurOrderBook
    ...
    Dim CrRptPurOrd As New CrRptPurOrderBook

    Private Sub FrmCrRptPurOrderBook_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        End Try
    End Sub
    Private Sub FrmCrRptPurOrderBook_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Top = 0
            Me.Left = 0
            Me.Size = New Point(Screen.PrimaryScreen.WorkingArea.Width - 30, 98)
            ...
            Fill_Combobox("purid", "purordno", "finactpurorder", "PURDELSTATUS", CInt(1), Me.CmbxLdgr)
    ...
    Private Sub FillTempTable_PurOrder()
        Try
            ...
            FinActConn.Open()
            cmd = New SqlCommand("Finact_Rpt_PurOrder_FillTalbe", FinActConn)
    ...
    Private Sub SelRecd_Fromtable_PurOrderSelect()
        Try
            ...
            Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_PurOrder_Select", Me.CrRptPurOrd, Me.CrRptVewPurOrdrBook, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptPurOrd, Me.CrRptVewPurOrdrBook, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptPurOrd, Me.CrRptVewPurOrdrBook, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
