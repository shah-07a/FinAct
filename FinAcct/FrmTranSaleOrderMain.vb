...
Public Class FrmTranSaleOrderMain
    ...
    Private Sub BtnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnNew.Click
        ...
        Dim FrmNewAdd As New FrmTranSaleOrder
    ...
    End Sub
    Private Sub FrmTranSaleOrderMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Top = 0
            Me.Left = 0
    ...
    Private Sub fill_gridview()
        Dim temp As String = ""
        Try
            OrdrCmd = New SqlCommand("Finact_Saleorder_Select", FinActConn1)
            OrdrCmd.CommandType = CommandType.StoredProcedure
            OrdrCmd.Parameters.AddWithValue("xxCond", Trim(Me.CmbxFltr.Text))
    ...
    Private Sub Btnedit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btnedit.Click
        If Me.dgOrder.SelectedRows.Count > 0 Then
            ...
            x_OrdrStatus1 = Trim(Me.dgOrder.SelectedRows(0).Cells(3).Value)

            Dim FrmOrdrEdit As New FrmTranSaleOrder
                ...
                If Trim(Me.dgOrder.CurrentRow.Cells(3).Value) = "Cancelled" Or Trim(Me.dgOrder.CurrentRow.Cells(3).Value) = "Worksheet" Then
                    If MessageBox.Show("Are you sure to delete current record?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        Try
                            ...
                            OrdrCmd = New SqlCommand("Delete from finactSaleorder where Saleid=@pid", FinActConn)
                        ...
                        Try
                            Dim Delid As Integer = Me.dgOrder.SelectedRows(0).Cells(7).Value
                            OrdrCmd = New SqlCommand("Delete from finactSaleorder_details where dSaleconcrnid=@pid1", FinActConn)
    ...
    Private Sub BtnAll_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnfilter.GotFocus _
    , Btnedit.GotFocus, BtnFind.GotFocus, BtnNew.GotFocus
        Try
    ...
    Private Sub BtnAll_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnedit.Leave _
    , Btnedit.Leave, BtnFind.Leave, BtnNew.Leave
        Try
            Dim xBtn As Button = CType(sender, Button)
