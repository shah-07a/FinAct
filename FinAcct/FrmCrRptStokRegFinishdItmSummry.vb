...
Public Class FrmCrRptStokRegFinishdItmSummry
    ...
    Dim CrRptStokRegFinshd As New CrRptStockRegFinishedItmSummary

    Private Sub FrmCrRptStokRegFinishdItmSummry_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        End Try
    End Sub
    Private Sub FrmCrRptStokRegFinishdItmSummry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Top = 0
            Me.Left = 0
            ...
            Fill_Combobox_where_cond("itmid", "itmname", "itmtype", "finactitmmstr", "ITMDELSTATUS", CInt(1), "Sale", Me.CmbxLdgr)
    ...
    Private Sub SelRecd_Fromtable_StokIssue()
        Try
            ...
            Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_StokIssueDetails_Finished_Select", Me.CrRptStokRegFinshd, Me.CrRptVewStokFinishdItm, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptStokRegFinshd, Me.CrRptVewStokFinishdItm, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptStokRegFinshd, Me.CrRptVewStokFinishdItm, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
