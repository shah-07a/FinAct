...
Public Class frmcrrptsaleorder
    ...
    Dim CrRptSaleOrd As New CrRptSaleOrder
    ...
    Private Sub SelRecd_Fromtable_PurOrderSelect()
        Try
            ...
            Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_PurOrder_Select", Me.CrRptSaleOrd, Me.CrRptVewSaleOrdr, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptSaleOrd, Me.CrRptVewSaleOrdr, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptSaleOrd, Me.CrRptVewSaleOrdr, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
