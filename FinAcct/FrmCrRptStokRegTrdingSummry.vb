...
Public Class FrmCrRptStokRegTrdsumrTrdingSummry
    ...
    Dim CrRptStokRegTrdsumr As New CrRptStockRegTrdingSummary
    ...
    Private Sub FrmRptGenLdgr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Fill_Combobox_where_cond("itmid", "itmname", "itmtype", "finactitmmstr", "ITMDELSTATUS", CInt(1), "Trading", Me.CmbxLdgr)
    ...
    Private Sub SelRecd_Fromtable_StokIssue()
        Try
            ...
            Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_StokIssueDetails_Trading_Select", Me.CrRptStokRegTrdsumr, Me.CrRptVewLdgr, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptStokRegTrdsumr, Me.CrRptVewLdgr, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptStokRegTrdsumr, Me.CrRptVewLdgr, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
