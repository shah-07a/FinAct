...
Public Class FrmRptBalanceSheet
    ...
    Dim CrRPtBal As New CrRptBalSheetMain
    ...
    Private Sub FrmRptBalanceSheet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Size = New Point(Screen.PrimaryScreen.WorkingArea.Width - 50, 103)
            Me.Top = 0
            Me.Left = 0
    ...
    ''        If FinActConn.State Then FinActConn.Close()
    ''        FinActConn.Open()
    ''        cmd = New SqlCommand("Finact_Rpt_TPL_FORBALSHEET_Select", FinActConn)
    ''        cmd.CommandType = CommandType.StoredProcedure
    ''        rdr = cmd.ExecuteReader
    ''        While rdr.Read
    ''            If rdr.IsDBNull(1) = False Then
    ...
    ''        Me.CrRPtBal.DataDefinition.ParameterFields("T_Texp").ApplyCurrentValues(ParmVal1)
    ''        Me.CrRPtBal.DataDefinition.ParameterFields("T_Income").ApplyCurrentValues(ParmVal2)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("T_IIncome").ApplyCurrentValues(ParmVal3)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("T_IExpense").ApplyCurrentValues(ParmVal4)

    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("Gprofit").ApplyCurrentValues(ParmVal5)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("Clstok").ApplyCurrentValues(ParmVal6)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("sretd").ApplyCurrentValues(ParmVal7)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("pretd").ApplyCurrentValues(ParmVal8)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("Ttolgpincome").ApplyCurrentValues(ParmVal9)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("T_Income2").ApplyCurrentValues(ParmVal10)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("sretd2").ApplyCurrentValues(ParmVal11)
    ''        ''Me.CrRPtBal.DataDefinition.ParameterFields("nEtPROFIT").ApplyCurrentValues(ParmVal12)
