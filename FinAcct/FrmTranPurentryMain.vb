...
Public Class FrmTranPurentryMain
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTranPurentryMain))
        ...
        Me.Panel4.BackgroundImage = Global.FinAcct.My.Resources.Resources.Treesinclouds7717hi
        ...
        Me.SplitContainer1.Location = New System.Drawing.Point(2, 73)
        ...
        'LblTPur
        '
        Me.LblTPur.BackColor = System.Drawing.Color.White
        Me.LblTPur.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.LblTPur.Font = New System.Drawing.Font("Verdana", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.LblTPur.Location = New System.Drawing.Point(9, 27)
        Me.LblTPur.Name = "LblTPur"
        Me.LblTPur.Size = New System.Drawing.Size(128, 22)
        Me.LblTPur.TabIndex = 5
        ...
        Me.BtnPurClose.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.BtnPurClose.ForeColor = System.Drawing.Color.Navy
        Me.BtnPurClose.Location = New System.Drawing.Point(9, 442)
        ...
        Me.BtnPurFilter.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.BtnPurFilter.ForeColor = System.Drawing.Color.Navy
        Me.BtnPurFilter.Location = New System.Drawing.Point(9, 404)
        ...
        Me.BtnPurFind.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.BtnPurFind.ForeColor = System.Drawing.Color.Navy
        Me.BtnPurFind.Location = New System.Drawing.Point(9, 366)
        ...
        Me.BtnPurEdit.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.BtnPurEdit.ForeColor = System.Drawing.Color.Navy
        Me.BtnPurEdit.Location = New System.Drawing.Point(9, 328)
        ...
        Me.BtnPurNew.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.BtnPurNew.ForeColor = System.Drawing.Color.Navy
        Me.BtnPurNew.Location = New System.Drawing.Point(9, 290)
        ...
        Me.DgPurEntery.Dock = System.Windows.Forms.DockStyle.Fill
        Me.DgPurEntery.Location = New System.Drawing.Point(0, 0)
        Me.DgPurEntery.Name = "DgPurEntery"
        Me.DgPurEntery.Size = New System.Drawing.Size(836, 481)
...
#End Region
    ...
    Private Sub BtnPurNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPurNew.Click
        Dim FrmNped As New FrmTranPurEnteryDirect  'FrmTranPurEntryMulty 
        FrmNped.ShowInTaskbar = False
        FrmNped.ShowDialog()
    ...
    Private Sub BtnPurEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPurEdit.Click
        If Me.DgPurEntery.SelectedRows.Count = 1 Then
            ...
            xPurEntFlag = Me.DgPurEntery.SelectedRows(0).Cells(8).Value
            Dim frmEdit As New FrmTranPurEnteryDirectEdit
    ...
    Public Sub fill_Purentgridview()
        ...
        Try
            If Cl_Kbl = True Then
                PurEntCmd = New SqlCommand("Finact_Purentry_kbltype_Select", FinActConn1)

                If xMACH_xPurxBILLING = True Then
                    PurEntCmd.Parameters.AddWithValue("@xType", CInt(2))
                Else
                    PurEntCmd.Parameters.AddWithValue("@xType", CInt(1))
                End If
            Else
                PurEntCmd = New SqlCommand("Finact_purentry_Select", FinActConn1)
            End If
            ...
            Me.DgPurEntery.Columns(3).Width = 100
            ...
            Me.DgPurEntery.Columns(8).HeaderText = "Type"
            Me.DgPurEntery.Columns(8).Width = 0
            Me.DgPurEntery.Columns(8).Visible = False
                ...
                If MessageBox.Show("It is strognly suggested not to delete entry(ies). Are you sure to delete current record?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                    Try
                        ...
                        While PurEntRdr.Read
                            Dim x As Object = PurEntRdr("xMessage")
    ...
    Private Sub BtnAllx_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnPurNew.GotFocus, BtnPurClose.GotFocus _
    ...
    Private Sub BtnAll_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnPurClose.Leave, BtnPurEdit.Leave _
