...
Public Class FrmRptPayAble
    ...
    Private Sub FrmRptGenLdgr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Fill_Combobox_Dynamiclly_Where_Cond2_NotIn_COND(Me.CmbxLdgr, "FinactGrupName", "Cogrpid", "CogrupNam", "CoGrupNam", "CoBalhed", "PRIMARY", "PRIMARY", "Assets", "CoDelStatus", CInt(1))
            FillTempTable_Ldgr()
            Me.DtpLdgr1.Focus()
        Catch ex As Exception
    ...
    Private Sub SelRecd_Fromtable_Ldgr()
        Try
            ...
            If xSndryDrRptFlag = True Then

                CrRptLdgr = New CrRptSundryDrCr
