...
Public Class FrmTranPurEntryBlngUsingChln
    ...
    Private Sub FrmTranPurEntryBlngUsingChln_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Select_2rec_where("spcatid", "spcatname", "spcattype", "Finactsalepurcatgry", CmbxVATrate, cond, "SPCATDELSTATUS", CInt(1))
        ...
        Try
            ...
            While FinActRdr.Read
                If FinActRdr.IsDBNull(0) = False Then
                    ...
                    xCarriId = CInt(FinActRdr("dpurentcarriId"))
                End If
            End While
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Private Sub xSavePurEntryChllan()
        Try
            ...
            FinActCmd.Parameters.AddWithValue("@purentlocid", CInt(10000)) '==10k stands for none
            FinActCmd.Parameters.AddWithValue("@purentcarri", CInt(xCarriId))
            ...
            FinActCmd.Parameters.AddWithValue("@PurEnt_UGRUP", CInt(Me.CmbxLdgrHead.SelectedValue))
    ...
    Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
        Try
            Dim FrmPc As New FrmTranPurEntryBlngUsingChlnEdit
