...
Imports System.IO
Public Class FrmTranPurEntryThruChln
    ...
    Private Sub FrmTranPurOrder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            End If
            Me.Text = "Purchase Entry (Through Challan)" & "  Current User Name:-  " & Trim(Current_UserName) & ",Designation:- " & Trim(Current_UserDesi)
    ...
    Private Sub BtnPe_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSe_Save.Click
        Try
            If Me.CmbxCarri.SelectedIndex = -1 Or Me.CmbxWareh.SelectedIndex = -1 Or Me.CmbxSplr.SelectedIndex = -1 Then
    ...
    Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
        Try
            Dim xS As New FrmTranPurEntryThruChlnEdit
