...
Public Class FrmCrRptPurRegstrCategorywise
        ...
        Try
            ...
            Else
                If Me.ChkRptType.CheckState = CheckState.Checked Then
                    CrRptSaleReg = New CrRptPurSummryCatWise
                Else
                    CrRptSaleReg = New CrRptPurRptHeadWise
                End If
            ...
            End If
            Fetch_Stock_Record_SelectedDateRange("FINACT_PurENTRY_HEADWISE_Purchase_SELECT", Me.CrRptSaleReg, Me.CrRptVewSaleRegstr, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date)
            SetExtraPramtoCrRpt()
