...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'Lblvno
        '
        Me.Lblvno.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        ...
        Me.Label5.Location = New System.Drawing.Point(4, 447)
        ...
        'TxtNarr
        '
        Me.TxtNarr.Anchor = CType((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
        Me.TxtNarr.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.TxtNarr.Enabled = False
        Me.TxtNarr.Location = New System.Drawing.Point(78, 447)
        Me.TxtNarr.MaxLength = 150
        Me.TxtNarr.Name = "TxtNarr"
        Me.TxtNarr.Size = New System.Drawing.Size(831, 20)
        ...
        Me.BtnAdd.Location = New System.Drawing.Point(488, 484)
        ...
        Me.BtnFnd.Location = New System.Drawing.Point(639, 484)
        ...
        Me.Btnclose.Location = New System.Drawing.Point(790, 484)
        ...
        Me.DgCrNote.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
        ...
        Me.DgCrNote.Size = New System.Drawing.Size(919, 342)
        ...
        'lblDR
        '
        Me.lblDR.Anchor = CType((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
        ...
        Me.lblDR.Location = New System.Drawing.Point(550, 421)
        Me.lblDR.Name = "lblDR"
        ...
        'lblCR
        '
        Me.lblCR.Anchor = CType((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
        ...
        Me.lblCR.Location = New System.Drawing.Point(729, 421)
        Me.lblCR.Name = "lblCR"
        ...
        Me.Label6.Location = New System.Drawing.Point(492, 422)
...
#End Region
    ...
    Private Sub FrmJrnl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Size = New Point(944, Screen.PrimaryScreen.WorkingArea.Height - 100)
            Me.Top = 0
            Me.Left = 0
            Add_Edit_Flag = True
    ...
    Private Function fetch_MxDate() As Date
        Try
            ...
            Csh_Bnk_Cmd.Parameters.AddWithValue("@xCondVal", "DrNote")
    ...
    Private Sub BtnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAdd.Click
        Try
            If Me.BtnAdd.Text.Trim = "&Add" Then
                Me.DtpkrJrnl.Focus()
                Me.BtnAdd.Text = "&Save"
                Exit Sub
            End If
    ...
    Private Sub Clr_Values_Ins()
        Try
            ...
            TxtNarr.Text = ""
            TxtNarr.Enabled = False
            Lblvno.Text = CInt(xSetDrNoteNo(xIniDrNoteSrNo))
            Me.lblCR.Text = ""
            Me.lblDR.Text = ""
            Me.lblDiff.Text = ""
        Catch ex As Exception
    ...
    Private Sub BtnFnd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFnd.Click
        Try
            If BtnFnd.Text = "&Edit" Then
                ...
                Dim FrmCrnEdt As New FrmDebitNoteEdit
    ...
    Private Sub Saverecord1() 'save record
        ...
        Try
            ...
            For Each Rwx As DataGridViewRow In Me.DgCrNote.Rows
                ...
                Try
                    ...
                    Csh_Bnk_Cmd.Parameters.AddWithValue("@CBtranVNo", 0)
                    Csh_Bnk_Cmd.Parameters.AddWithValue("@CBTRANCSHNO", CInt(Lblvno.Text))
                    ...
                    End If
                    Csh_Bnk_Cmd.Parameters.AddWithValue("@CBtranBokName", Trim("DrNote"))
        ...
        Finally
            ...
            If SaveStatus = True Then
                ...
                xDrCrNoteDt = Me.DtpkrJrnl.Value
                xDrCrNoteFlag = True
                xDrCrNoteAmt = CDbl(Me.lblDR.Text)
                xDrCrNo = CInt(Lblvno.Text)
                Clr_Values_Ins()
                Me.DgCrNote.Rows.Clear()
                Me.BtnAdd.Text = "&Add"
                If MessageBox.Show("Do you want to print current credit note?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Dim FrmDrN As New FrmCrRptDrNote
                    FrmDrN.ShowInTaskbar = False
                    FrmDrN.ShowDialog()
    ...
    Private Sub DtpkrJrnl_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles DtpkrJrnl.Leave
        Try
            ...
            If Add_Edit_Flag = True Then
                Lblvno.Text = CInt(xSetDrNoteNo(xIniDrNoteSrNo)) '  xFetchVno_dynamic("FinActCshBnk", "CBTranvno")
        ...
        End Try
    End Sub
    Private Function xSetDrNoteNo(ByVal xxDrNO As Integer) As Integer
        Try
            If xxDrNO > 0 Then
                Dim xMXX As Integer = xFetchMxVal_dynamic_1Cond("FINACTCSHBNK", "CBTranCshRno", "CBtranBokName", "DrNote")
                If xMXX > 0 Then
                    Return xMXX + 1
                Else
                    Return xxDrNO
