...
Public Class FrmShipadrs
    ...
    Private Sub FrmShipadrs_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If FrmShow_flag(18) = True Then
            CurSplrid = SplrID_Editx
        Else
            CurSplrid = FindMaxId(SplrName4Shp, SplrSurfix4Shp)
        End If
        If Chk_Exisit2("finact_shpadrsmstr", "shpid", "shpconcrnid", CurSplrid) = True Then
            Me.Left = 20
            Me.Top = 0
        ...
        Try
            If Trim(Btnsave.Text) = "&Save" Then
                ...
                If svindx <> 0 Then
                    ...
                    Exit Sub
                Else
                    If Chk_Exisit2("finact_shpadrsmstr", "shpid", "shpname", Trim(txtshpname.Text)) = True Then
    ...
    Private Sub Save_ShpAdrs()
        Try
            ShpCmd = New SqlCommand("finact_shpadrsmstr_insert", FinActConn)
            ShpCmd.CommandType = CommandType.StoredProcedure
            If FrmShow_flag(15) = True Then
            ...
            If Me.Chkshp.Checked = True Then
                ShpCmd.Parameters.AddWithValue("@shpchk", 1)
            Else
                ShpCmd.Parameters.AddWithValue("@shpchk", 0)
            End If
    ...
    Private Sub Create_fill_datagridShpMstr()
        Try
            ...
            dGshp.Columns.Add("dflt", "Default")
            ...
            dGshp.Columns(13).Width = 250
            dGshp.Columns(15).Width = 250
            ...
            sql.get_data("select_where", pn11, pv11, "shpmstr") ' shpmstr stands for shpadrsmstr
            ...
            For mk = 0 To sql.ds.Tables("shpmstr").Rows.Count - 1
                ...
                Cel = New DataGridViewTextBoxCell
                Cel.Value = sql.ds.Tables("Shpmstr").Rows(mk).ItemArray(5).ToString()
                DgShpr.Cells.Add(Cel)
                ...
                pv11(1) = "cscid"
                pv11(2) = sql.ds.Tables("Shpmstr").Rows(mk).ItemArray(6).ToString()
                ...
                Sql1.get_data("select_where_like", pn11, pv11, "cMa")
                ...
                Cel = New DataGridViewTextBoxCell
                Cel.Value = sql.ds.Tables("Shpmstr").Rows(mk).ItemArray(13).ToString()
                DgShpr.Cells.Add(Cel)
                ...
                Try
                    If dGshp.SelectedRows.Count > 0 Then
                        ...
                        For i = 0 To dGshp.SelectedRows.Count - 1
                            ShpCmd = New SqlCommand("Delete from finact_shpadrsmstr where shpid=@itmid", FinActConn)
            ...
            If b > 0 Then
                For i = 0 To dGshp.SelectedRows.Count - 1
                    If FlagEditAllow = True Then
                        ...
                        End If
                    End If
                    ShpCmd = New SqlCommand("Finact_shpadrsmstr_update", FinActConn)
                    ShpCmd.CommandType = CommandType.StoredProcedure
                    ShpCmd.Parameters.AddWithValue("@shpid", Me.dGshp.SelectedRows(i).Cells(0).Value)
                    ShpCmd.Parameters.AddWithValue("@shpname", Me.dGshp.SelectedRows(i).Cells(2).Value)
                    ShpCmd.Parameters.AddWithValue("@shpadrs", Me.dGshp.SelectedRows(i).Cells(3).Value)
                    ShpCmd.Parameters.AddWithValue("@shpadrs1", Me.dGshp.SelectedRows(i).Cells(4).Value)
                    ShpCmd.Parameters.AddWithValue("@shpadrs2", Me.dGshp.SelectedRows(i).Cells(5).Value)
                    Dim pn11(2), pv11(2) As String
                    pn11(0) = "@ta"
                    pn11(1) = "@id"
                    pn11(2) = "@idval"
                    pv11(0) = "finactcscmstr"
                    pv11(1) = "cscctyname"
                    pv11(2) = Me.dGshp.SelectedRows(i).Cells(6).Value
                    ...
                    ShpCmd.Parameters.AddWithValue("@shppin", Me.dGshp.SelectedRows(i).Cells(9).Value)
                    ShpCmd.Parameters.AddWithValue("@shpphno", Me.dGshp.SelectedRows(i).Cells(10).Value)
                    If Trim(Me.dGshp.SelectedRows(i).Cells(11).Value) = "True" Then
                        ShpCmd.Parameters.AddWithValue("@shpchk", 1)
                    Else
                        ShpCmd.Parameters.AddWithValue("@shpchk", 0)
                    End If
