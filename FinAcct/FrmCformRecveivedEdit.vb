...
Public Class FrmCformRecveivedEdit
    ...
    Private Sub SelRecd_Fromtable_SALEENTRY()
        Try
            ...
            FinActConn.Open()
            CFcmd = New SqlCommand("Finact_SALEENTRY_CFORM_Received_Edit_Select", FinActConn)
    ...
    Private Sub Fill_Combobox_Cforms()
        Dim xStr As String = "FINACT_Rpt_CForm_FILLCMBX_EDIT_Select"
        dtaset = New DataSet
        dtaset.Tables.Clear()
        Try
