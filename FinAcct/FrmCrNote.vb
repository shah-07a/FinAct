...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmCrNote))
        ...
        Me.Label3.Location = New System.Drawing.Point(604, 7)
        ...
        Me.Lblvno.Location = New System.Drawing.Point(650, 7)
        Me.Lblvno.Name = "Lblvno"
        Me.Lblvno.Size = New System.Drawing.Size(264, 20)
...
#End Region
    ...
    Private Function fetch_MxDate() As Date
        Try
            ...
            Csh_Bnk_Cmd.Parameters.AddWithValue("@xCondVal", "CrNote")
            Csh_Bnk_rdr = Csh_Bnk_Cmd.ExecuteReader
    ...
    Private Sub Clr_Values_Ins()
        Try
            ...
            TxtNarr.Text = ""
            TxtNarr.Enabled = False
            Lblvno.Text = CInt(xSetCrNoteNo(xIniCrNoteSrNo))
            Me.lblCR.Text = ""
            Me.lblDR.Text = ""
            Me.lblDiff.Text = ""
        Catch ex As Exception
    ...
    Private Sub BtnFnd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFnd.Click
        Try
            If BtnFnd.Text = "&Edit" Then
                Dim FrmCrnEdt As New FrmCreditNoteEdit
    ...
    Private Sub Saverecord1() 'save record
        ...
        Try
            ...
            For Each Rwx As DataGridViewRow In Me.DgCrNote.Rows
                ...
                Try
                    ...
                    End If
                    Csh_Bnk_Cmd.Parameters.AddWithValue("@CBtranBokName", Trim("CrNote"))
        ...
        Finally
            ...
            If SaveStatus = True Then
                ...
                xDrCrNoteFlag = True
                xDrCrNoteAmt = CDbl(Me.lblCR.Text)
    ...
    Private Sub DtpkrJrnl_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles DtpkrJrnl.Leave
        ...
        End Try
    End Sub
    Private Function xSetCrNoteNo(ByVal xxCrNO As Integer) As Integer
        Try
            If xxCrNO > 0 Then
                Dim xMXX As Integer = xFetchMxVal_dynamic_1Cond("FINACTCSHBNK", "CBTranCshRno", "CBtranBokName", "CrNote")
                If xMXX > 0 Then
                    Return xMXX + 1
                Else
                    Return xxCrNO
