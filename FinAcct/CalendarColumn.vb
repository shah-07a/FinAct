...
Public Class CalendarCell
    ...
    Public Overrides Sub InitializeEditingControl(ByVal rowIndex As Integer, _
        ...
        Date.TryParse(Me.Value, CurrCulture.DateTimeFormat, Globalization.DateTimeStyles.AssumeUniversal, CurrDate)
        If Me.Value.ToString <> "" Then ctl.Value = CurrDate.Date ' CType(Me.Value, Date)
