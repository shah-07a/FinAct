...
Public Class CrRptPackNote
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinAcct.CrRptPackNote.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptPackNote
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptPackNote = New CrRptPackNote
        rpt.Site = Me.Site
        Return rpt
    End Function
