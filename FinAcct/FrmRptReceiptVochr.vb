...
Public Class FrmRptReceiptVochr
    ...
    Dim CrRptrcpt As New CrRptReceipt
    ...
    Private Sub FillTempTable_Cbook()
        Try
            ...
            FinActConn.Open()
            cmd = New SqlCommand("Finact_Rpt_RecptVochr_FillTalbe", FinActConn)
    ...
    Private Sub BtnRptVewCb_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnRptVewCb.Click
        ...
        Try
            ...
            ''FrmMainMdi.MenuItem200.Enabled = False
            Handle_P_Bar(Me)
    ...
    Private Sub SelRecd_Fromtable_cb()
        Try
            If Me.Rbact.Checked = True Then
                ...
                Fetch_Stock_Record_SelectedDateRange_withSelITem("Finact_Rpt_RecptVochr_Select_Acct", Me.CrRptrcpt, Me.CrRptVewRecpt, Me.DtpCb1.Value.Date, DtpCb2.Value.Date, CStr(Actid))
            ElseIf Me.Rball.Checked = True Then
                Fetch_Stock_Record_SelectedDateRange("Finact_Rpt_RecptVochr_Select", Me.CrRptrcpt, Me.CrRptVewRecpt, Me.DtpCb1.Value.Date, Me.DtpCb2.Value.Date)
            ElseIf Me.RbVno.Checked = True Then
                Fetch_Stock_Record_SelectedDateRange_withVnoRange("Finact_Rpt_RecptVochr_Select_Vno", Me.CrRptrcpt, Me.CrRptVewRecpt, Me.DtpCb1.Value.Date, DtpCb2.Value.Date, Trim(Me.Txtvno1.Text), Trim(Me.Txtvno2.Text))
            End If
