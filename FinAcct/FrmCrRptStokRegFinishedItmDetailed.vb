...
Public Class FrmCrRptStokRegFinishedItmDetailed
    ...
    Dim CrRptStokRegFinshd As New CrRptStockRegFinishedDetailed
    ...
    Private Sub FillTempTable_StokRegsumr()
        Try
            ...
            FinActConn.Open()
            cmd = New SqlCommand("Finact_Rpt_StokDetails_Finished_FillTable", FinActConn)
    ...
    Private Sub SelRecd_Fromtable_StokIssue()
        Try
            ...
            ' Fetch1_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_StokIssueDetails_Finished_Select", Me.CrRptStokRegFinshd, Me.CrRptVewStokRegFinishedItm, Me.DtpLdgr1.Value, Me.DtpLdgr2.Value, Selact, Stype, Sbtype)
            Fetch1_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_StokIssueDetails_Finished_DateWiseWithOpnBal_Select", Me.CrRptStokRegFinshd, Me.CrRptVewStokRegFinishedItm, Me.DtpLdgr1.Value, Me.DtpLdgr2.Value, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptStokRegFinshd, Me.CrRptVewStokRegFinishedItm, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptStokRegFinshd, Me.CrRptVewStokRegFinishedItm, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
    ...
    , ChkRptLdgr.KeyDown, DtpLdgr2.KeyDown, ChkOpnBal.KeyDown, ChkAllac.KeyDown
        Try
    ...
    Private Sub FrmCrRptStokRegFinishedItmDetailed_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub FrmCrRptStokRegFinishedItmDetailed_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
