...
Public Class FrmCrRptStokRegistr
    ...
    Dim CrRptStokReg As New CrRptStockRegistr
    ...
    Private Sub SelRecd_Fromtable_StokIssue()
        Try
            ...
            Fetch1_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_StokIssueDetails_RawMatrl_with_without_opnbal_Select", Me.CrRptStokReg, Me.CrRptVewLdgr, Me.DtpLdgr1.Value, Me.DtpLdgr2.Value, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptStokReg, Me.CrRptVewLdgr, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptStokReg, Me.CrRptVewLdgr, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
    ...
    , ChkRptLdgr.KeyDown, DtpLdgr2.KeyDown, ChkAllac.KeyDown, ChkOpnBal.KeyDown
        Try
