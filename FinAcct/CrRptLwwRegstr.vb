...
Public Class CrRptLwwRegstr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinAcct.CrRptLwwRegstr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptLwwRegstr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptLwwRegstr = New CrRptLwwRegstr
        rpt.Site = Me.Site
        Return rpt
    End Function
