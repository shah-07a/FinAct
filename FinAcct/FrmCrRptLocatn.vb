...
Public Class FrmCrRptlocatn
    ...
    Private Sub CoprofileParamscsc()
        ...
        Try
            ...
            OdbcDa.Fill(datatbl)
            Dim CRptcsc1 As New CrRptLocatn
            CRptcsc1.SetDataSource(datatbl)
            Try
                ...
                While OdbcRdr1.Read()
                    ...
                    CRptcsc1.DataDefinition.ParameterFields("Coname").ApplyCurrentValues(ParmVal1)
                    CRptcsc1.DataDefinition.ParameterFields("Adrs").ApplyCurrentValues(ParmVal2)
                    CRptcsc1.DataDefinition.ParameterFields("Csc").ApplyCurrentValues(ParmVal3)
                    CRptcsc1.DataDefinition.ParameterFields("con").ApplyCurrentValues(ParmVal4)
                End While
            ...
            CrVewcsc.ReportSource = CRptcsc1
        Catch ex As SqlException
            MsgBox(ex.Number & " " & ex.Message)
        Finally
