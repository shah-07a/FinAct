    ...
    Private Sub Save_Recd()
        Try
            ...
            If Trim(BtnSave.Text) = "&Save" Then
                Itmconfig_cmd = New SqlCommand("finact_itmwdthmstr_insert", FinActConn)
            ...
            Try
                If dg.SelectedRows.Count > 0 Then
                    ...
                    For i = 0 To dg.SelectedRows.Count - 1
                        Itmconfig_cmd = New SqlCommand("Delete from finact_itmwdthmstr where itmwdthid=@itmid", FinActConn)
        ...
        Try
            ...
            If b > 0 Then
                For i = 0 To dg.SelectedRows.Count - 1
                    ...
                    Itmconfig_cmd = New SqlCommand("Finact_itmwdthmstr_update", FinActConn)
                    Itmconfig_cmd.CommandType = CommandType.StoredProcedure
                    Itmconfig_cmd.Parameters.AddWithValue("@itmId", Me.dg.SelectedRows(i).Cells(0).Value)
    ...
    Private Function ChkExisiting_Rec() As Boolean
        Try
            ...
            Else
                Intype = "Mm"
            End If
            Itmconfig_cmd = New SqlCommand("select itmwdthin,itmwdthtype from finact_itmwdthmstr where itmwdthin=@in and itmwdthtype=@type", FinActConn)
