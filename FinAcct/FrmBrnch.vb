...
Public Class FrmBrnch
        ...
        If BtnSave.Text = "&Save" Then
            ...
            If SveCnfrm = vbYes Then
                If addFlag = True Then
                    ...
                    CatCmd.Parameters.AddWithValue("@type", Trim("Brnch"))
                ...
                Catch ex As Exception
                    MsgBox("Violation of Primary key" + Chr(10) + "Name already exist, you can not insert Duplicate record." + Chr(13) + "This Record has been terminated.", MsgBoxStyle.Critical, "Branch Name Already Exist!")
    ...
    Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
        If BtnFind.Text = "&Find" Then
            ...
            CatCmd = New SqlCommand("Select * from finactdept where deptdelstatus=1 and depttype='" & Trim("Brnch") & "' order by deptname ", FinActConn)
            Try
    ...
    Private Sub Btnedt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
