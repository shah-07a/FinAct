...
Public Class FrmRptRecvAble
    ...
    Private Sub FrmRptGenLdgr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Fill_Combobox_Dynamiclly_Where_Cond2_NotIn_COND(Me.CmbxLdgr, "FinactGrupName", "Cogrpid", "CogrupNam", "CoGrupNam", "CoBalhed", "PRIMARY", "PRIMARY", "Liabilities", "CoDelStatus", CInt(1))
            FillTempTable_Ldgr()
            Me.DtpLdgr1.Focus()
        Catch ex As Exception
    ...
    Private Sub SelRecd_Fromtable_Ldgr()
        Try
            ...
            If xSndryCrRptFlag = True Then

                CrRptLdgr = New CrRptSundryCrDr
                Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_Ledger_SundryDrCr_Select", Me.CrRptLdgr, Me.CrRptVewLdgr, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)
