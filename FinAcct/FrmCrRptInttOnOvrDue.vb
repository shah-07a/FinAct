...
Public Class FrmCrRptInttOnOvrDue
    ...
    Private Sub xFilltable()
        Try
            ...
            FinActConn.Open()
            RSBCMD = New SqlCommand("Finact_SALEENTRY_INTEREST_ONOVERDUES_Select", FinActConn)
    ...
    Private Sub xSelRec()
        Try
            If FinActConn.State Then FinActConn.Close()
            FinActConn.Open()
            RSBCMD = New SqlCommand("FINACT_Rpt_TEMP_SALEBILL_OVERDUE_INTT_Select", FinActConn)
            RSBCMD.CommandType = CommandType.StoredProcedure
