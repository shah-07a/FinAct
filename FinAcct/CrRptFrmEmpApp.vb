...
Public Class CrRptFrmEmpApp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinAcct.CrRptFrmEmpApp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptFrmEmpApp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptFrmEmpApp = New CrRptFrmEmpApp
        rpt.Site = Me.Site
        Return rpt
    End Function
