...
Public Class FrmRptLedgerWithBillInfo
    ...
    Dim CrRptLdgr As New CrRptLedgerWithBillInfo
    ...
    Private Sub FillTempTable_Ldgr()
        Try
            ...
            FinActConn.Open()
            cmd = New SqlCommand("Finact_Rpt_LedgerWithBillInfo_FillTalbe", FinActConn)
