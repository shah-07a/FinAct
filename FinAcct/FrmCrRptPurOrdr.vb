...
Public Class FrmCrRptPurOrdr
    ...
    Dim CrRptPurOrd As New CrRptPurOrder

    Private Sub FrmCrRptPurOrdr_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        End Try
    End Sub
    Private Sub FrmCrRptPurOrdr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub SelRecd_Fromtable_PurOrderSelect()
        Try
            ...
            Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_PurOrder_Select", Me.CrRptPurOrd, Me.CrRptVewPurOrder, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptPurOrd, Me.CrRptVewPurOrder, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptPurOrd, Me.CrRptVewPurOrder, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
