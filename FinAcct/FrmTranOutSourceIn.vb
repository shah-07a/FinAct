...
Public Class FrmTranOutSourceIn
    ...
    Private Sub FrmTranPurOrder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Size = New System.Drawing.Point(834, 640)
        ...
        CreateGridColumns()
        Me.Text = "New OutSourcing Inward Entry"
    ...
    Private Sub dtpordrdt_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtpordrdt.GotFocus
    ...
    Private Sub PurEntrySave()
        If Me.DgPurDirect.Rows.Count >= 1 Then
            Try
                ...
                TpoCmd.Parameters.AddWithValue("@purentType", 2) '=== 1 stands for in house production and 2 for out side production.
            ...
            Try
                ...
                For DgCntr = 0 To Me.DgPurDirect.Rows.Count - 1
                    If Me.DgPurDirect.Rows(DgCntr).Cells(6).Value = 1 Then
                        TpoCmd = New SqlCommand("Finact_Purentry_Details_outsource_Insert", FinActConn)
                        TpoCmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub CreateGridColumns()
        ...
        Me.DgPurDirect.Columns("amt").Width = 130
        ...
        ''Me.DgPurDirect.Columns.Add("iunt", "Units")
        ''Me.DgPurDirect.Columns("Iname").Width = 35
        ''Me.DgPurDirect.Columns("Iname").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
        ''Me.DgPurDirect.Columns("iunt").DisplayIndex = 3
    ...
    , ChkInv.KeyDown, Chkprnt.KeyDown, CmbxCarri.KeyDown, Cmbxdistype.KeyDown, Cmbxspcatid.KeyDown, Cmbxstatus.KeyDown, CmbxWareh.KeyDown, Dtpgrdt.KeyDown, dtpordrdt.KeyDown, DtppurDue.KeyDown _
    ...
    , rbattach.KeyDown, Rbpur.KeyDown, Rbxcode.KeyDown, Rbxicode.KeyDown, RbxiName.KeyDown, RbxName.KeyDown, TxtCariNo.KeyDown, Txtcoment.KeyDown, Txtgrno.KeyDown, TxtinsCo.KeyDown _
    , TxtPlcyno.KeyDown, TxtPurBillNo.KeyDown, Txtuload.KeyDown, txtvCode.KeyDown, TxtVname.KeyDown
        Try
            If e.KeyCode = Keys.Enter Then
                SendKeys.Send("{tab}")
            End If
    ...
    Private Sub ToolStripMenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem2.Click
        Try
            For Each Rx As DataGridViewRow In Me.DgPurDirect.SelectedRows
                Me.DgPurDirect.Rows.RemoveAt(Rx.Index)
            Next
        Catch ex As Exception
