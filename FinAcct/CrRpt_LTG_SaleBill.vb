...
Public Class CrRpt_LTG_SaleBill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinAcct.CrRpt_LTG_SaleBill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRpt_LTG_SaleBill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRpt_LTG_SaleBill = New CrRpt_LTG_SaleBill
        rpt.Site = Me.Site
        Return rpt
    End Function
