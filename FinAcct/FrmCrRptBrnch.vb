...
Public Class FrmCrRptbrnch
    ...
    Private Sub CoprofileParamsbrnch()
        Try
            ...
            Try
                ...
                OdbcDa = New OdbcDataAdapter("Select * from Finactdept where depttype ='" & ("Brnch") & "' order by deptname,deptid", FinactOdbcCon)
                OdbcDa.Fill(datatbl)
                Dim CRptBrnch1 As New CrRptBrnch
                CRptBrnch1.SetDataSource(datatbl)
                Try
                    ...
                    While OdbcRdr1.Read()
                        ...
                        CRptBrnch1.DataDefinition.ParameterFields("Coname").ApplyCurrentValues(ParmVal1)
                        CRptBrnch1.DataDefinition.ParameterFields("Adrs").ApplyCurrentValues(ParmVal2)
                        CRptBrnch1.DataDefinition.ParameterFields("Csc").ApplyCurrentValues(ParmVal3)
                        CRptBrnch1.DataDefinition.ParameterFields("con").ApplyCurrentValues(ParmVal4)
                    End While
                ...
                CrVewBrnch.ReportSource = CRptBrnch1
            Catch ex As SqlException
                MsgBox(ex.Number & " " & ex.Message)
            Finally
                OdbcDa.Dispose()
