...
Public Class FrmRptCreditNote
    ...
    Dim CrRptCrn As New CrRptCreditNote
    ...
    Private Sub FrmRptJrnl_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        cmd = New SqlCommand("Delete from FinAct_TEMP_CrNoteRegister", FinActConn)
        Try
            cmd.ExecuteNonQuery()
        ...
        Finally
            cmd = Nothing
            ''FrmMainMdi.MenuItem212.Enabled = True
    ...
    Private Sub FillTempTable_Jrnl()
        Try
            ...
            FinActConn.Open()
            cmd = New SqlCommand("Finact_Rpt_CreditNote_FillTalbe", FinActConn)
    ...
    Private Sub BtnRptVewJrnl_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnRptVewJrnl.Click
        Try
            ...
            ''FrmMainMdi.MenuItem212.Enabled = False
            Handle_P_Bar(Me)
    ...
    Private Sub SelRecd_Fromtable_Jrnl()
        Try
            Fetch_Stock_Record_SelectedDateRange("Finact_Rpt_CrNote_Select", Me.CrRptCrn, Me.CrRptVewCrn, Me.DtpJrnl1.Value.Date, Me.DtpJrnl2.Value.Date)
            If Me.ChkRptJrnl.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptCrn, Me.CrRptVewCrn, True, True, Me.DtpJrnl1, Me.DtpJrnl2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptCrn, Me.CrRptVewCrn, True, False, Me.DtpJrnl1, Me.DtpJrnl2)
            End If
    ...
    Private Sub ALLcONTROLS_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles DtpJrnl1.KeyDown, ChkRptJrnl.KeyDown, DtpJrnl2.KeyDown
        Try
