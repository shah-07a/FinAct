...
Public Class FrmCrRptSaleOrderBook
    ...
    Dim CrRptSaleOrdbk As New CrRptSaleOrderBook

    Private Sub FrmCrRptSaleOrderBook_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        End Try
    End Sub
    Private Sub FrmCrRptSaleOrderBook_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Top = 0
            Me.Left = 0
    ...
    Private Sub FillTempTable_PurOrder()
        Try
            ...
            FinActConn.Open()
            cmd = New SqlCommand("Finact_Rpt_SaleOrder_FillTalbe", FinActConn)
    ...
    Private Sub SelRecd_Fromtable_PurOrderSelect()
        Try
            ...
            Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_PurOrder_Select", Me.CrRptSaleOrdbk, Me.CrRptVewSaleOrdrBook, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptSaleOrdbk, Me.CrRptVewSaleOrdrBook, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptSaleOrdbk, Me.CrRptVewSaleOrdrBook, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
