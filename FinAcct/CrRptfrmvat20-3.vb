...
Public Class CrRptfrmvat20_3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinAcct.CrRptfrmvat20-3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptfrmvat20_3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptfrmvat20_3 = New CrRptfrmvat20_3
        rpt.Site = Me.Site
        Return rpt
    End Function
