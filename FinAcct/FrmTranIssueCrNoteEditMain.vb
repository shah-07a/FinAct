...
Public Class FrmTranIssueCrNoteEditMain
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTranIssueCrNoteEditMain))
        ...
        Me.Panel4.BackgroundImage = Global.FinAcct.My.Resources.Resources.METALC5C
        ...
        Me.BtnSaleClose.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Blue
        Me.BtnSaleClose.FlatStyle = System.Windows.Forms.FlatStyle.Flat
        Me.BtnSaleClose.Font = New System.Drawing.Font("Arial", 11.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.BtnSaleFilter.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Blue
        Me.BtnSaleFilter.FlatStyle = System.Windows.Forms.FlatStyle.Flat
        Me.BtnSaleFilter.Font = New System.Drawing.Font("Arial", 11.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.BtnSaleFind.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Blue
        Me.BtnSaleFind.FlatStyle = System.Windows.Forms.FlatStyle.Flat
        Me.BtnSaleFind.Font = New System.Drawing.Font("Arial", 11.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.BtnSaleEdit.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Blue
        Me.BtnSaleEdit.FlatStyle = System.Windows.Forms.FlatStyle.Flat
        Me.BtnSaleEdit.Font = New System.Drawing.Font("Arial", 11.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.Name = "FrmTranIssueCrNoteEditMain"
        Me.Text = "Item(s) Rejected/Returned Back Alter Section"
...
#End Region
    ...
    Private Sub BtnSaleEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSaleEdit.Click
        If Me.DgSaleEntery.SelectedRows.Count = 1 Then
            Try
                ...
                Dim FrmIDNE As New FrmTranIssuecrNoteEdit
    ...
    Public Sub fill_Purentgridview()
        Dim temp As String = ""
        Try
            SaleEntCmd = New SqlCommand("Finact_SBR_Pur_entry_Select", FinActConn1)
            ...
            SaleEntAdptr.Fill(dtaset, "finactPurentry")
            Me.DgSaleEntery.DataSource = dtaset.Tables("FinactPurentry")
            ...
            If Me.DgSaleEntery.SelectedRows.Count = 1 Then
                Try
                    If MessageBox.Show("Are you sure to delete current record?", "Deleting Confirmation!!!", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        If xxVATrtrnStatus("SBR_Entid", "SBRVATrtrnFlg", Delid, "FinactPurItemBackRecdEntry") = True Then
                        ...
                        Else
                            ...
                            FinActConn.Open()
                            SaleEntCmd = New SqlCommand("Finact_SBR_Pur_DelFromAllTableAttached_Delete", FinActConn)
                            SaleEntCmd.CommandType = CommandType.StoredProcedure
