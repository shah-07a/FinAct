...
Public Class CrRptfrmvat20
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinAcct.CrRptfrmvat20.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptfrmvat20
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptfrmvat20 = New CrRptfrmvat20
        rpt.Site = Me.Site
        Return rpt
    End Function
