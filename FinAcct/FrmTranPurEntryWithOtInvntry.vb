...
Imports System.IO
Public Class FrmTranPurEntryWithOtInvntry
    ...
    Private Sub FrmTranPurOrder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If xWrkContrct_Flag = True Then
                ...
                If xDynamic_COUNT_xAnItem_xInA_Table_1cond("Purentid", "PurentBILLtype", "JBWRK", "FinactPurentry") > 0 Then
                    Me.BtnFind.Enabled = True
                Else
                    Me.BtnFind.Enabled = False
                End If
                Me.Text = "Purchase Entry (Job/Work-Contract)" & "  (CURRENT USER NAME:- " & Trim(Current_UserName) & ",DESIGNATION:- " & Trim(Current_UserDesi)
            ...
            Else
                ...
                Me.Text = "Purchase Entry (Without Inventory)" & "  (CURRENT USER NAME:- " & Trim(Current_UserName) & ",DESIGNATION:- " & Trim(Current_UserDesi)
    ...
    , Txtgrno.KeyDown, TxtPlcyno.KeyDown, TxtPvtMrk.KeyDown, TxtPurBillNo.KeyDown, Txtuload.KeyDown _
    ...
    Private Sub BtnPe_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSe_Save.Click
        Try
            ...
            If Chk_zeroQnty() = True Then
                ...
                Exit Sub
            End If
            If Me.MTxtTotlamt.Text = 0 Then
                MsgBox("Invalid input!", MsgBoxStyle.Critical, "Check Invoice Amount...")
    ...
    Private Sub PurEntrySave()
        If Me.DgPurDirect.Rows.Count > 0 Then
            Try
                ...
                If xWrkContrct_Flag = True Then
                    TpoCmd.Parameters.AddWithValue("@PurENTBILLTYPE", "JBWRK")
                Else
                    TpoCmd.Parameters.AddWithValue("@PurENTBILLTYPE", "NOINV")
                End If
                If xWrkContrct_Flag = True Then
            ...
            Dim CurrPbillId As Integer = FindlastId(Trim(TxtPurBillNo.Text), CInt(Me.CmbxSplr.SelectedValue))
            Try
                ...
                Me.DgPurDirect.Rows(0).Cells(0).Value = 1
                Me.DgPurDirect.Rows(0).Cells(1).Value = "Purchase Item(s)"
    ...
    Private Sub CreateGridColumns()
        ...
        ' Me.DgPurDirect.Columns("rate").ReadOnly = True
        '3
        ...
        'Me.DgPurDirect.Columns("amt").ReadOnly = True
        ...
        Me.DgPurDirect.Rows(0).Cells(0).Value = 1
        If xWrkContrct_Flag = True Then
            Me.DgPurDirect.Rows(0).Cells(1).Value = "Labour Job/Work-Contract"
        Else
            Me.DgPurDirect.Rows(0).Cells(1).Value = "Purchase Item(s)"
        End If
            ...
            If CheckBlank_Cmbx(Me.Cmbxspcatid) = True Then
                ...
                If Me.Panel8.Enabled = False Then
                    ...
                    If Me.DgPurDirect.Rows.Count = 0 Then
                        ...
                        Me.DgPurDirect.Rows(0).Cells(0).Value = 1
                        Me.DgPurDirect.Rows(0).Cells(1).Value = "Purchase Item(s)"
                        Me.DgPurDirect.CurrentCell = Me.DgPurDirect.Item(2, 0)
                    End If
                    Dim rx As Integer = Me.DgPurDirect.Rows.Count - 1
                    Me.DgPurDirect.CurrentCell = Me.DgPurDirect.Item(2, rx)
                    Me.DgPurDirect.Rows(rx).Cells(2).Selected = True
                Else
                    Me.Chkbdisc.Focus()
                End If
            End If
    ...
    Private Sub DgPurDirect_CellLeave(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgPurDirect.CellLeave
        Try
    ...
    Private Sub DgPurDirect_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles DgPurDirect.KeyDown
        ...
        Try
            If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
                If Me.DgPurDirect.CurrentCell.ColumnIndex = 2 Then ' Me.DgPurDirect.ColumnCount = 3 Then
                    If IsDBNull(Me.DgPurDirect.CurrentRow.Cells(0).Value) = False And IsDBNull(Me.DgPurDirect.CurrentRow.Cells(1).Value) = False And IsDBNull(Me.DgPurDirect.CurrentRow.Cells(2).Value) = False Then
                        Dim Val1 As Double
                        Dim Val2 As Double
                        Dim ic As String
                        ...
                        Val2 = Me.DgPurDirect.CurrentRow.Cells(2).Value

                        If Not (Val1) > 0 Then
                            Me.DgPurDirect.CurrentRow.Cells(0).ErrorText = "Value should be greater than zero"
                        ElseIf Not (Val2) > 0 Then
                            Me.DgPurDirect.CurrentRow.Cells(2).ErrorText = "Value should be greater than zero"
                        Else
                            If Trim(Me.DgPurDirect.CurrentRow.Cells(0).ErrorText) <> "" Or Trim(Me.DgPurDirect.CurrentRow.Cells(1).ErrorText) <> "" Or Trim(Me.DgPurDirect.CurrentRow.Cells(2).ErrorText) <> "" Then
                                MsgBox("Invalid Input", MsgBoxStyle.Critical, Me.Text)
                                Me.SaveFlag = False
                                Exit Sub
                            Else
                    ...
                    If Me.DgPurDirect.CurrentCell.RowIndex < Me.DgPurDirect.RowCount - 1 Then
                        Me.DgPurDirect.CurrentCell = Me.DgPurDirect.Item(2, Me.DgPurDirect.CurrentCell.RowIndex + 1)
                        Me.DgPurDirect.CurrentRow.Cells(0).Value = 1
                        If xWrkContrct_Flag = True Then
                            Me.DgPurDirect.CurrentRow.Cells(1).Value = "Labour Job/Work-Contract"
                        Else
                            Me.DgPurDirect.CurrentRow.Cells(1).Value = "Purchase Item(s)"
                        End If
    ...
    Private Function Chk_zeroQnty() As Boolean
        Try
            ...
            For xxc = 0 To Me.DgPurDirect.RowCount - 1
                If Not (Me.DgPurDirect.Rows(xxc).Cells(0).Value) > 0 Or Not (Me.DgPurDirect.Rows(xxc).Cells(2).Value) > 0 Then
        ...
        Try
            If CheckBlank_Cmbx(Me.CmbxSplr) = True Then
                ...
                If xWrkContrct_Flag = True Then
                    ...
                    If xSumOfField > xTDSminLmt Then
                        Me.ChkbxTds.CheckState = CheckState.Checked
                        Me.ChkbxTds.Enabled = False
                    Else
                        Me.ChkbxTds.CheckState = CheckState.Unchecked
                        Me.ChkbxTds.Enabled = True
                    End If
                    If Me.DgPurDirect.RowCount > 0 Then
                        mskTxtVAtCst_TextChanged(sender, e)
                    End If
                End If
    ...
    Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
        Try
            Dim xS As New FrmTranPurEntryWithOtInvntryEdit
    ...
    Private Sub xAllContrl_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles ChkbCariDetals.GotFocus, Chkbdisc.GotFocus, ChkbOthrCharg.GotFocus, MTxtTotlamt.GotFocus
        Try
    ...
    End Sub
    Private Sub xAllContrl_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles ChkbCariDetals.Leave, Chkbdisc.Leave, ChkbOthrCharg.Leave, MTxtTotlamt.Leave
        Try
            Dim xx As Control = CType(sender, Control)
    ...
    Private Sub ToolStripMenuItem10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem10.Click
        Try
            If Len(Me.LbltablAmt.Text) > 0 Then
                ...
                Me.TxtTxableAmt.Location = New System.Drawing.Point(786, 476)
    ...
    Private Sub ToolStripMenuItem11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem11.Click
        Try
            If Len(Me.LblSurCharg.Text) > 0 Then
                ...
                Me.TxtSurChrg.Location = New System.Drawing.Point(786, 514)
    ...
    Private Sub ToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem1.Click
        Try
            If Len(Me.LblVATCST.Text) > 0 Then
                Me.TxtVATamt.Text = FormatNumber(Me.LblVATCST.Text, 2)
                Me.TxtVATamt.Location = New System.Drawing.Point(786, 495)
