...
Public Class FrmTranIssueDrNoteEdit
    ...
    Private Sub FrmTranSaleOrder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End Try
    End Sub
    Private Sub Set_QltyType()
        Select Case SBRType
            Case "1stQlty"
                Me.RbTrt1.Enabled = True
                Me.RbTrt1.Checked = True
                Me.RbTrt2nd.Enabled = False
                Me.RbTrtPart.Enabled = False
            Case "2ndQlty"
                Me.RbTrt1.Enabled = False
                Me.RbTrt2nd.Enabled = True
                Me.RbTrt2nd.Checked = True
                Me.RbTrtPart.Enabled = False
            Case "MixQlty"
                Me.RbTrt1.Enabled = False
                Me.RbTrt2nd.Enabled = False
                Me.RbTrtPart.Enabled = True
                Me.RbTrtPart.Checked = True
        End Select
    End Sub
    ...
    Private Sub CreateGridColumns_Saleentr_Edit()
        ...
        Try
            TpoCmd1 = New SqlCommand("Finact_FinactSaleItemBackRecdEntry_Select_Where_id", FinActConn1)
            ...
            If TpoRdr1.IsDBNull(0) = False Then
                ...
                Me.CmbxPlist.SelectedValue = TpoRdr1("SBR_entplistid")
        ...
        Try
            ...
            If Me.RbTrtPart.Checked = True Then
                TpoCmd1 = New SqlCommand("Finact_FinactSaleItemBackRecdEntry1___Where_Concrnid", FinActConn1)
                TpoCmd1.Parameters.AddWithValue("@SaleentConcrnid", Selected_xInvoice_xId)

            Else
                TpoCmd1 = New SqlCommand("Finact_FinactSaleItemBackRecdEntry_Details__Where_Concrnid", FinActConn1)
                TpoCmd1.Parameters.AddWithValue("@SaleentConcrnid", Selected_xInvoice_xId)
            End If
            ...
            TpoAdptr.Fill(dtaset, "FinactSaleItemBackRecdEntry_Details")
            DgItms.DataSource = dtaset.Tables("FinactSaleItemBackRecdEntry_Details")
    ...
    Private Sub find_Item_list(ByVal CurString1 As String)
        ...
        Try
            ...
            TpoCmd.CommandType = CommandType.StoredProcedure
            TpoCmd.Parameters.AddWithValue("@Sale_Pur_Type1", "SaleOnly")
  ...
  , RbxiName.KeyDown, RbxName.KeyDown, Txtcoment.KeyDown, txtlbltot.KeyDown, TxtSaleBillNo.KeyDown, TxtVatinvno.KeyDown, txtvCode.KeyDown, TxtVname.KeyDown
        ...
        If Me.DgSaleDirect.Rows.Count >= 1 Then
            Try
                ...
                Else
                    ChkQlty = "MixQlty"
                End If
                TpoCmd = New SqlCommand("finact_SaleItemBackRecdEntry_update", FinActConn)
                TpoCmd.CommandType = CommandType.StoredProcedure
                ...
                For DgCntr = 0 To Me.DgSaleDirect.Rows.Count - 1
                    If Me.DgSaleDirect.Rows(DgCntr).Cells(10).Value = 1 Then
                        ...
                        If Me.RbTrt2nd.Checked = True Then
                            TpoCmd = New SqlCommand("Finact_SaleItemBackRecdEntry_Details_update", FinActConn)
                            TpoCmd.CommandType = CommandType.StoredProcedure
                            TpoCmd.Parameters.AddWithValue("@d_SBR_entconcrnid", (CurrPbillId))
                            TpoCmd.Parameters.AddWithValue("@Recid", xxRecid)
                        ...
                        ElseIf Me.RbTrt1.Checked = True Then
                            If ChkExistingInBom(xxItemId) = False Then
                                TpoCmd = New SqlCommand("Finact_SBR_FirstQltyOtherThanBom_Details_update", FinActConn)
                                TpoCmd.CommandType = CommandType.StoredProcedure
                                ...
                                TpoCmd.Dispose()
                            Else
                                TpoCmd = New SqlCommand("Finact_SBR_FirstQlty_Details_update", FinActConn)
                                TpoCmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub BtnItmDetails_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnItmDetails.Click
        Try
            ...
            If Me.DgSaleDirect.SelectedRows.Count > 0 Then
                SBRItmId = Me.DgSaleDirect.SelectedRows(0).Cells(7).Value
                SBRqnty = Me.DgSaleDirect.SelectedRows(0).Cells(0).Value
                xxSelRowIndx = Me.DgSaleDirect.SelectedRows(0).Index
                SBRBillNo = Trim(Me.TxtSaleBillNo.Text)
                SBRid = Me.DgSaleDirect.SelectedRows(0).Cells(6).Value
                ...
                Dim frmSBR As New FrmSaleItmRecdBackDetailsEdit
    ...
    Private Sub Save_If_bomItemshandles()
        Try
            ...
            Dim ItmIdforbom As Integer = Me.DgSaleDirect.SelectedRows(0).Cells(7).Value
            ...
            Else
                ChkQlty = "MixQlty"
            End If
            TpoCmd = New SqlCommand("finact_SaleItemBackRecdEntry_temp_insert", FinActConn)
            TpoCmd.CommandType = CommandType.StoredProcedure
