...
Imports System.IO
Public Class FrmTranSaleEntryThruChlnEdit
    ...
    Private Sub FrmTranPurOrder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Me.Text = "Sale Entry (Through Challan) Edit Mode" & "  (CURRENT USER NAME:- " & Trim(Current_UserName) & ",DESIGNATION:- " & Trim(Current_UserDesi)
    ...
    Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
        Try
            Me.Close()
            Dim xS As New FrmTranSaleEntryThruChln
