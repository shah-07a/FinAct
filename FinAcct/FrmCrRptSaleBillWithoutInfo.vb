...
Public Class FrmCrRptSaleBillWithoutInfo
    ...
    Dim CrRptSbill As New CrRptSaleBillWithoutInfo
    ...
    Private Sub SelRecd_Fromtable_StokIssue()
        Try
            ...
            Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_PurEntry_Select", Me.CrRptSbill, Me.CrRptVewSaleBill, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)
            SetExtraPramtoCrRpt()
            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptSbill, Me.CrRptVewSaleBill, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptSbill, Me.CrRptVewSaleBill, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
