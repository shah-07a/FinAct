...
Public Class FrmCrRptcsciner
    ...
    Private Sub CoprofileParamscsciner()
        ...
        Try
            ...
            Try
                ...
                OdbcDa = New OdbcDataAdapter("Select * from FinactCsCmstr where csctype <>'" & ("Outer") & "' order by cscctyname,cscid", FinactOdbcCon)
                OdbcDa.Fill(datatbl)
                Dim CRptcsciner1 As New CrRprCsCIner
                CRptcsciner1.SetDataSource(datatbl)
                Try
                    ...
                    While OdbcRdr1.Read()
                        ...
                        CRptcsciner1.DataDefinition.ParameterFields("Coname").ApplyCurrentValues(ParmVal1)
                        CRptcsciner1.DataDefinition.ParameterFields("Adrs").ApplyCurrentValues(ParmVal2)
                        CRptcsciner1.DataDefinition.ParameterFields("Csc").ApplyCurrentValues(ParmVal3)
                        CRptcsciner1.DataDefinition.ParameterFields("con").ApplyCurrentValues(ParmVal4)
                    End While
                ...
                CrVewiner.ReportSource = CRptcsciner1
            Catch ex As SqlException
                MsgBox(ex.Number & " " & ex.Message)
            Finally
                ''Odbccon.Close()
