...
Public Class FrmCrRptStokRegSumristrSummary
    ...
    Dim CrRptStokRegSumr As New CrRptStockRegistrSummary
    ...
    Private Sub FrmRptGenLdgr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Size = New Point(Screen.PrimaryScreen.WorkingArea.Width - 30, 100)
            Me.Top = 0
            Me.Left = 0
            ...
            Fill_Combobox_where_cond("itmid", "itmname", "itmtype", "finactitmmstr", "ITMDELSTATUS", CInt(1), "Purchase", Me.CmbxLdgr)
    ...
    Private Sub FillTempTable_StokRegsumr()
        Try
            ...
            FinActConn.Open()
            cmd = New SqlCommand("Finact_Rpt_StokDetails_RawMaterials_FillTable", FinActConn)
    ...
    Private Sub SelRecd_Fromtable_StokIssue()
        Try
            ...
            'Finact_Rpt_TEMP_StokIssueDetails_RawMatrl_with_without_opnbal_Select
            Fetch_Stock_Record_SelectedDateRange_withSelITem_and_BalType("Finact_Rpt_TEMP_StokIssueDetails_Select", Me.CrRptStokRegSumr, Me.CrRptVewLdgr, Me.DtpLdgr1.Value.Date, Me.DtpLdgr2.Value.Date, Selact, Stype, Sbtype)

            If Me.ChkRptLdgr.Checked = True Then
                CoprofileParamsRest_Adrs(Me.CrRptStokRegSumr, Me.CrRptVewLdgr, True, True, Me.DtpLdgr1, Me.DtpLdgr2)
            Else
                CoprofileParamsRest_Adrs(Me.CrRptStokRegSumr, Me.CrRptVewLdgr, True, False, Me.DtpLdgr1, Me.DtpLdgr2)
            End If
