...
Public Class FrmCrRptPurBillPrinting
    ...
    Private Sub FillTempTable_StokReg()
        Try
            ...
            FinActConn.Open()
            cmd = New SqlCommand("Finact_Rpt_PurentryBillPrinting_FillTable", FinActConn)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.AddWithValue("@PBill", Trim(x_PBillNO_x))
